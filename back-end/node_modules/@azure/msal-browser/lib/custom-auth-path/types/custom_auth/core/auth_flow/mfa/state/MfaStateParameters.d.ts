...
export interface MfaStateParameters extends AuthFlowActionRequiredStateParameters {
    mfaClient: MfaClient;
    cacheClient: CustomAuthSilentCacheClient;
    scopes?: string[];
}
export interface MfaVerificationRequiredStateParameters extends MfaStateParameters {
...
//# sourceMappingURL=MfaStateParameters.d.ts.map